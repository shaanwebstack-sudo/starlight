        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-600">
              Choose the learning program that matches your academic,
              competitive examination or skill-development goals.
            </p>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-3xl border border-blue-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="mt-3 leading-7 text-gray-600">
                Structured preparation and guidance for major government and
              ...
              <Link
                href="/admission?category=government_exam"
                className="mt-6 inline-flex items-center font-semibold text-blue-700 hover:text-blue-800"
              >
            ...
            <div className="rounded-3xl border border-red-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="mt-3 leading-7 text-gray-600">
                Guidance and academic support for NIOS Secondary and Senior
                Secondary learners.
              </p>
              ...
              <Link
                href="/admission?category=nios"
                className="mt-6 inline-flex items-center font-semibold text-red-700 hover:text-red-800"
              >
                Explore NIOS Programs
            ...
            <div className="rounded-3xl border border-purple-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">

              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-100">

                <School className="h-7 w-7 text-purple-700" />
              ...
              <p className="mt-3 leading-7 text-gray-600">
                Academic support, admission assistance and examination
                guidance for open-schooling learners.
              </p>
              ...
              <Link
                href="/admission?category=open_schooling"
                className="mt-6 inline-flex items-center font-semibold text-purple-700 hover:text-purple-800"
              >
                Explore Open Schooling
            ...
            <div className="rounded-3xl border border-emerald-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">

              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-100">

                <Laptop className="h-7 w-7 text-emerald-700" />
              ...
              <p className="mt-3 leading-7 text-gray-600">
                Practical computer and digital-skill programs designed for
              ...
              <Link
                href="/admission?category=computer"
                className="mt-6 inline-flex items-center font-semibold text-emerald-700 hover:text-emerald-800"
              >
            ...
            <div className="rounded-3xl border border-orange-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="mt-3 leading-7 text-gray-600">
                Academic learning support for students across school-level
                subjects and educational programs.
              </p>
              ...
              <Link
                href="/admission"
                className="mt-6 inline-flex items-center font-semibold text-orange-700 hover:text-orange-800"
              >
            ...
            <div className="rounded-3xl border border-indigo-100 bg-white p-7 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">

              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-100">

                <Languages className="h-7 w-7 text-indigo-700" />
              ...
              <p className="mt-3 leading-7 text-gray-600">
                Develop English language skills for academic, communication
                and competitive examination needs.
              </p>
              ...
              <Link
                href="/admission"
                className="mt-6 inline-flex items-center font-semibold text-indigo-700 hover:text-indigo-800"
              >
                Enquire About English Programs
